...
Η εικόνα από την κάμερα θα μεταφέρεται ζωντανά σε μια οθόνη λάπτοπ, στο κέντρο ελέγχου του οχήματος, ώστε να λαμβάνονται οι καλύτερες αποφάσεις από τις πληροφορίες που μεταφέρει.
