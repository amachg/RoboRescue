...
Επίσης στο Raspberry Pi, δημιουργήσαμε μια υπηρεσία  rescue_car.service με την εντολή ``sudo systemctl daemon-reload  `` ώστε όταν ανοίγει να δημιουργεί αυτόματα
