...
### Υλοποίηση:
Χρησιμοποιήσαμε ένα τηλεκατευθυνόμενο τετρακίνητο όχημα από προυγούμενο διαγωνισμό και το εφοδιάσαμε με έναν μικρο-υπολογιστή Raspberry Pi 5, που φέρεται μέσα στο όχημα και τροφοδοτείται από τις μπαταρίες του.

Σε αυτόν εγκαταστήσαμε έναν εξυπηρετητή βίντεο Mediamtx (https://github.com/bluenviron/mediamtx), ώστε να καταφέρουμε ζωντανή μετάδοση βίντεο στον ιστό (over the web), με πολύ χαμηλή καθυστέρυση μετάδοσης στο επίπεδο των λίγων χιλιοστών του δευτερόλεπτου. To Raspberry Pi δημιουργεί ένα ανοιχτό σημείο πρόσβασης (wifi hotspot) στο οποίο συνδέονται συσκευές από απόσταση μέχρι και 200 μέτρα. Έτσι μπορεί να στριμάρει ασύρματα στις συνδεδεμένες συσκευές την εικόνα από την κάμερά του.
