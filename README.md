...
Ρυθμίσαμε το Raspberry Pi ώστε όταν ανοίγει να δημιουργεί αυτόματα ένα ανοιχτό σημείο πρόσβασης (wifi hotspot) στο οποίο συνδέονται συσκευές από απόσταση μέχρι και 200 μέτρα. Έτσι μπορεί να στριμάρει ασύρματα στις συνδεδεμένες συσκευές την εικόνα από την κάμερά του.
