...
Το όχημά μας είναι ένα τηλεχειριζόμενο, ευέλικτο, όχημα (τετρακίνητο εδάφους), με κάμερα, που βοηθάει στη διάσωση τραυματισμένων ή εγκλωβισμένων ανθρώπων σε περιπτώσεις έκτακτης ανάγκης.
